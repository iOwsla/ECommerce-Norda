...
const checkCartCount = () => {
    $.ajax({
        ...
        success: function (response) {
            document.querySelectorAll(".cart-count").forEach(e => e.innerHTML = response);
        },
...
document.querySelectorAll(".add-to-cart").forEach(function (element) {
    element.addEventListener("click", function (e) {
        ...
        const stockCount = element.getAttribute("stock");
        ...
        if (stockCount <= 0) {
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
                text: 'Error! Stock count is not enough!',
            ...
            success: function (response) {
                if (response == "Ok") {
                    ...
                    Swal.fire({
                        icon: 'error',
                        title: 'Oops...',
                        text: 'Error! Product not added to cart!',
                        confirmButtonText: 'Ok',
                    });
                    return;
                }
